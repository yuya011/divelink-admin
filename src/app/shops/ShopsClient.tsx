...
interface ShopsClientProps {
    initialApplications: ShopApplication[];
}

export default function ShopsClient({ initialApplications }: ShopsClientProps) {
    const router = useRouter();
    const [applications, setApplications] = useState<ShopApplication[]>(initialApplications);
    ...
    const refreshData = () => {
        ...
        // router.refreshは非同期だがPromiseを返さないため、適当なタイムアウトでloadingを消す
